...
class ExcelProcessor:
    ...
    def Make_Excel(self, file_path: str) -> bool:
        ...
        try:
            ...
            self._create_worksheet('Capital Gains Summary')
            ...
            ws.write_rich_string(
                2, 0,
                formats["blue_h"], "Before 23",
                formats["super"], "rd",
                formats["blue_h"], " July 2024",
                formats["blue_h"]
            )
            ...
            ws.write_rich_string(
                3, 0,
                formats["dblue_h"], "After 23",
                formats["super"], "rd",
                formats["dblue_h"], " July 2024",
                formats["dblue_h"]
            )
            ...
            """ ##################### CALCULATING VALUES ##################### """
            before_23 = self.df[self.df["Date of Sale/Transfer"] < pd.to_datetime("2024-07-23")]
            after_23 = self.df[self.df["Date of Sale/Transfer"] >= pd.to_datetime("2024-07-23")]
            ...
            fvc_sort_Before_23 = short_before_23["Sales Consideration - Reported by Source"].sum() 
            fvc_sort_After_23 = short_after_23["Sales Consideration - Reported by Source"].sum()
            fvc_long_Before_23 = long_before_23["Sales Consideration - Reported by Source"].sum()
            fvc_long_After_23 = long_after_23["Sales Consideration - Reported by Source"].sum()
            fvc_long_After_23 = long_after_23["Sales Consideration - Reported by Source"].sum()
